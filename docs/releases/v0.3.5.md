---
title: "v0.3.5 - Jun 2025"
description: "Mochi v0.3.5 introduces a new **fetch** expression for performing HTTP requests. Responses are decoded into typed values, and optional `with` parameters allow setting the HTTP method, headers, and body. The interpreter ships with a..."
