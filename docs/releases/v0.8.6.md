---
title: "v0.8.6 - Jun 2025"
description: "Mochi v0.8.6 brings the first five LeetCode examples to every experimental compiler. New language features and runners make these programs compile and run across the entire project."
sidebar_label: "v0.8.6"
