---
title: "v0.10.2 - Jun 2025"
description: "Mochi v0.10.2 extends group query features and improves dataset tooling. The runtime gains richer stack traces and a new `values` builtin while compilers add `sum` helpers and group filtering across languages."
