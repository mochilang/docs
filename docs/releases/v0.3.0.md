---
title: "v0.3.0 - Jun 2025"
description: "Mochi v0.3.0 introduces **first-class generative AI support** through the new `generate text` block. Programs can now invoke large language models (LLMs) directly from within Mochi code, using natural language prompts to generate text..."
