---
title: "v0.5.0 - Jun 2025"
description: "Mochi v0.5.0 introduces **agents** along with enhanced string handling and control flow. Agents keep persistent state, expose intent functions and react to events from streams. Strings can be indexed, iterated and checked for..."
