---
title: "v0.3.1 - Jun 2025"
description: "Mochi v0.3.1 expands on the generative AI foundation introduced in v0.3.0 by adding **first-class support for user-defined types** and **structured AI output generation**. Programs can now declare their own rich types, instantiate them..."
