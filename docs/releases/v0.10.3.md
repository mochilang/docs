---
title: "v0.10.3 - Jun 2025"
description: "Mochi v0.10.3 introduces typed dataset fetch and JSON persistence. Many compilers now emit typed fetch helpers with HTTP tests while datasets can be loaded from and saved to JSON files."
sidebar_label: "v0.10.3"
